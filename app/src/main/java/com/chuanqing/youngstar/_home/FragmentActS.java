...
import com.chuanqing.youngstar.myadapter.AdapterFragActSRV;
...
public class FragmentActS extends BaseFragment {
    private int page=1;
    private AdapterFragActSRV adapter;
    @Nullable
    @Override
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new AdapterFragActSRV(getContext());
    ...
    private void request(String user) {
        OkGo.post(Urls.getActivityByuserCode)//
                .tag(this)//
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        Log.e("=============", "ACTS"+s);
                        FragStarActSBean bean = new Gson().fromJson(s, FragStarActSBean.class);
                        List<FragStarActSBean.DataBean.PageInfoBean.ListBean> list = bean.getData().getPageInfo().getList();
